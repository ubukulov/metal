        ...
        <div class="footer_content">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>ОО "KazMetallStal-Almaty" занимается производством и реализацией продукции различных металлов и сплавов. Ассортимент продукции обладает огромным количеством наименованией изделий. Вся продукция прошла контроль качеств и обладает всеми необходимыми сертификатами.</p>
